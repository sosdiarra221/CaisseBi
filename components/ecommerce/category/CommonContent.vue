      ...
      <div class="grid grid-cols-12 gap-x-6">
            ...
            <div class="sm:p-5 p-4">
              <form>
                <div class="mb-4">
                  ...
                  <input type="text" class="py-1.5 px-3 h-11 border border-border rounded-lg w-full duration-500 focus:border-primary bg-transparent" placeholder="Meta Tag Name" />
                </div>
              </form>
              ...
              <div class="mt-4">
                ...
                <input type="text" class="py-1.5 px-3 h-11 border border-border rounded-lg w-full duration-500 focus:border-primary bg-transparent" placeholder="Meta Tag Keywords" />
              </div>
            </div>
          </div>
          <div class="card !h-auto">
        ...
        <div class="xl:col-span-4 col-span-12">
          <div class="sticky top-29 mb-6">
                ...
                <div class="avatar-upload flex items-center">
                  <div class="relative">
                    <div class="border border-border p-2 mb-2.5 rounded-lg">
                      <div id="imagePreview" class="inline-block relative object-cover bg-cover bg-no-repeat bg-center h-29 w-full" :style="`background-image: url(${bgPicked})`"></div>
                    </div>
            ...
            <div class="card !h-auto">
              <div class="border-b border-border relative py-4 px-5 flex justify-between items-center flex-wrap">
                <h4 class="text-base">Store Template</h4>
              </div>
              <div class="sm:p-5 p-4">
