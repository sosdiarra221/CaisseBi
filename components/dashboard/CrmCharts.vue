    ...
    <div class="xl:col-span-3 sm:col-span-6 col-span-12">
      <div class="card chart-grd same-card overflow-hidden relative">
        <div class="card-body depostit-card p-0">
          <div class="depostit-card-media flex justify-between px-5 pt-4.5 relative z-1">
            <div>
              <h6 class="font-normal">Total Deposit</h6>
              <h3 class="font-semibold leading-[1.346]">$1200.00</h3>
            </div>
            <div class="icon-box bg-primarylight h-[2.5rem] w-[2.5rem] relative flex items-center justify-center rounded-md">
          ...
          <div id="NewCustomers">
            <VueApexCharts height="40px" :series="state.series" :options="state.options" />
          </div>
        </div>
      </div>
    </div>
    <div class="xl:col-span-3 sm:col-span-6 col-span-12">
      <div class="card same-card relative flex flex-col">
        <div class="card-body flex items-center px-5 py-2 flex-auto">
          <div id="AllProject" class="ml-[-2.063rem]">
            <VueApexCharts height="100px" :series="state2.series" :options="state2.options" />
          </div>
          <ul class="project-list">
            <li class="py-px text-body whitespace-nowrap mb-0.5"><h6 class="font-medium">All Projects</h6></li>
            <li class="py-px text-body whitespace-nowrap">
      ...
      <div class="card chart-grd same-card overflow-hidden relative">
        <div class="card-body depostit-card p-0">
          <div class="depostit-card-media flex justify-between px-5 pt-4.5 relative z-1">
            ...
            <div class="icon-box bg-dangerlight h-[2.5rem] w-[2.5rem] relative flex items-center justify-center rounded-md">
              <svg width="12" height="20" viewBox="0 0 12 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                  d="M11.4642 13.7074C11.4759 12.1252 10.8504 10.8738 9.60279 9.99009C8.6392 9.30968 7.46984 8.95476 6.33882 8.6137C3.98274 7.89943 3.29927 7.52321 3.29927 6.3965C3.29927 5.14147 4.93028 4.69493 6.32655 4.69493C7.34341 4.69493 8.51331 5.01109 9.23985 5.47964L10.6802 3.24887C9.73069 2.6333 8.43112 2.21342 7.14783 2.0831V0H4.49076V2.22918C2.12884 2.74876 0.640949 4.29246 0.640949 6.3965C0.640949 7.87005 1.25327 9.03865 2.45745 9.86289C3.37331 10.4921 4.49028 10.83 5.56927 11.1572C7.88027 11.8557 8.81873 12.2813 8.80805 13.691L8.80799 13.7014C8.80799 14.8845 7.24005 15.3051 5.89676 15.3051C4.62786 15.3051 3.248 14.749 2.46582 13.9222L0.535522 15.7481C1.52607 16.7957 2.96523 17.5364 4.4907 17.8267V20.0001H7.14783V17.8735C9.7724 17.4978 11.4616 15.9177 11.4642 13.7074Z"
                  fill="#FF5E5E"
          ...
          <div id="NewExperience">
            <VueApexCharts height="40px" :series="state3.series" :options="state3.options" />
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="card">
        <div class="card-body depostit-card p-5">
          ...
          <div class="progress-box mt-0">
            ...
            <div class="progress h-2.5 flex overflow-hidden rounded-md bg-light mt-[0.188rem]">
              <div class="progress-bar bg-primary" style="width: 50%; height: 10px; border-radius: 4px" role="progressbar"></div>
            </div>
          </div>
        </div>
      </div>
