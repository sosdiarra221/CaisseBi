...
<template>
  <div class="xl:col-span-4 sm:col-span-6 col-span-12">
    <div class="card !bg-[#fbe7e733] dark:!bg-[#e555550d] !border-danger overflow-hidden">
      <div class="relative py-4.5 px-5">
        <div class="flex justify-between mb-4">
          <h4 class="text-base">Sell Order</h4>
        ...
        <div class="block">
          <OptionSelect
            class-name="py-1.5 px-3 h-11 border border-border rounded-lg w-full duration-500 focus:border-[#999999] nice-select form-control float-none mt-4 sm:mt-0 inline-flex wide items-center border-border bg-d-bg !h-auto image-select"
            :options="[
              { img: IMAGES.dash, lable: 'Dash Coin' },
              { img: IMAGES.btc, lable: 'Ripple' },
              { img: IMAGES.eth, lable: 'Ethereum' },
              { img: IMAGES.btc, lable: 'Bitcoin' },
            ]"
          />
        </div>
      </div>
      <div>
        <div class="overflow-x-auto">
          <table class="w-full text-center">
            <thead>
              <tr>
                <th class="py-2.5 px-5 font-bold text-danger text-start">Price</th>
                <th class="py-2.5 px-5 font-bold text-danger text-center">Amount</th>
                <th class="py-2.5 px-5 font-bold text-danger text-end">Total</th>
              </tr>
            </thead>
            <tbody>
              <tr class="hover:bg-d-bg hover:shadow-hover">
                <td class="py-2.5 px-5 text-secondary text-start">82.3</td>
                <td class="py-2.5 px-5 text-secondary">0.15</td>
                <td class="py-2.5 px-5 text-secondary text-right">$134,12</td>
              </tr>
              <tr class="hover:bg-d-bg hover:shadow-hover">
                <td class="py-2.5 px-5 text-secondary text-start">58.3</td>
                <td class="py-2.5 px-5 text-secondary">0.15</td>
                <td class="py-2.5 px-5 text-secondary text-right">$134,12</td>
              </tr>
              <tr class="hover:bg-d-bg hover:shadow-hover">
                <td class="py-2.5 px-5 text-secondary text-start">33.3</td>
                <td class="py-2.5 px-5 text-secondary">0.15</td>
                <td class="py-2.5 px-5 text-secondary text-right">$124,12</td>
              </tr>
              <tr class="hover:bg-d-bg hover:shadow-hover">
                <td class="py-2.5 px-5 text-secondary text-start">92.3</td>
                <td class="py-2.5 px-5 text-secondary">0.15</td>
                <td class="py-2.5 px-5 text-secondary text-right">$184,12</td>
              </tr>
              <tr class="hover:bg-d-bg hover:shadow-hover">
                <td class="py-2.5 px-5 text-secondary text-start">87.3</td>
                <td class="py-2.5 px-5 text-secondary">53.7</td>
                <td class="py-2.5 px-5 text-secondary text-right">$184,12</td>
              </tr>
              <tr class="hover:bg-d-bg hover:shadow-hover">
                <td class="py-2.5 px-5 text-secondary text-start">82.3</td>
  ...
  <div class="xl:col-span-4 sm:col-span-6 col-span-12">
    <div class="card !bg-[#cefff633] dark:!bg-[#01bd9b0d] !border-success overflow-hidden">
      <div class="relative py-4.5 px-5">
        <div class="flex justify-between mb-3">
          <h4 class="text-base">Buy Order</h4>
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
      ...
      <div>
        <div class="overflow-x-auto">
          <table class="w-full text-center">
            <thead>
              <tr>
                <th class="py-2.5 px-5 font-bold text-success text-start">Price</th>
                <th class="py-2.5 px-5 font-bold text-success text-center">Amount</th>
                <th class="py-2.5 px-5 font-bold text-success text-end">Total</th>
              </tr>
            </thead>
            <tbody>
              <tr class="hover:bg-d-bg hover:shadow-hover">
  ...
  <div class="xl:col-span-4 sm:col-span-6 col-span-12">
    <div class="card">
      <div class="relative py-4.5 px-5 flex justify-between items-center pb-2">
        <h4 class="text-base">Quick Transfer</h4>
      </div>
      <div class="sm:p-5 p-4 pt-0">
        <OptionSelect
          class-name="py-1.5 px-3 h-11 border border-border rounded-lg w-full duration-500 focus:border-[#999999] nice-select form-control float-none mt-4 sm:mt-0 inline-flex wide items-center border-border bg-d-bg !h-auto image-select"
          :options="[
            { img: IMAGES.dash, lable: 'Dash Coin' },
        ...
        />
        <div class="border border-primary py-1.5 px-3.6 rounded-lg my-4">
          <label class="text-primary font-semibold text-[11px] mb-0">Total BPL</label>
          <div class="relative flex flex-wrap items-stretch w-full">
            <input
              type="text"
              class="bg-transparent h-7 relative flex-auto w-[1%] text-secondary text-lg font-bold placeholder:text-secondary placeholder:text-lg placeholder:font-bold"
              placeholder="24,246"
              aria-label="Recipient's username"
            />
            <span class="!p-0 !font-semibold h-2.5 input-group-text" id="basic-addon20">BTL</span>
          </div>
        </div>
        <div class="flex justify-between">
          <h4 class="mb-2 text-sm uppercase">Recent Contacts</h4>
          <a href="javascript:void(0);" class="text-primary">View All</a>
        </div>
        <Swiper class="owl-carousel owl-carousel owl-loaded front-view-slider" :loop="true" :slides-per-view="2.5" :space-between="30">
          <SwiperSlide class="items">
            <div class="card bg-light shadow-none text-center">
              <div class="sm:p-5 p-4">
                <img src="assets/images/avatar/pic2.jpg" alt="" class="h-10 !w-auto m-auto rounded-full" />
                <h4 class="text-sm">Cindy</h4>
                <span>@sam224</span>
              </div>
            </div>
          </SwiperSlide>
          <SwiperSlide class="items">
            <div class="card bg-light shadow-none text-center">
              <div class="sm:p-5 p-4">
                <img src="assets/images/avatar/pic3.jpg" alt="" class="h-10 !w-auto m-auto rounded-full" />
                <h4 class="text-sm">Monty</h4>
                <span>@mon854</span>
              </div>
            </div>
          </SwiperSlide>
          <SwiperSlide class="items">
            <div class="card bg-light shadow-none text-center">
              <div class="sm:p-5 p-4">
                <img src="assets/images/avatar/pic4.jpg" alt="" class="h-10 !w-auto m-auto rounded-full" />
                <h4 class="text-sm">Piter</h4>
                <span>@pit234</span>
              </div>
            </div>
          </SwiperSlide>
          <SwiperSlide class="items">
            <div class="card bg-light shadow-none text-center">
              <div class="sm:p-5 p-4">
                <img src="assets/images/avatar/pic5.jpg" alt="" class="h-10 !w-auto m-auto rounded-full" />
                <h4 class="text-sm">Jasi</h4>
                <span>@jas234</span>
              </div>
            </div>
          </SwiperSlide>
      ...
      <div class="py-4 px-5 grid">
        <button class="btn bg-primary hover:bg-primaryhover hover:shadow-btnprimary text-white">TRANSFER NOW</button>
      </div>
    </div>
  </div>
