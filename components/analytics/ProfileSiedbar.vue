...
<template>
  <div class="card sidebar-profile dz-scroll">
    <div class="relative py-4.5 px-5 flex justify-between items-center flex-wrap pt-6">
      <h4 class="text-xl font-bold">Recent Contact</h4>
    </div>
    <div class="sm:p-5 p-4">
      <div class="grid grid-cols-12 gap-2">
        <div class="lg:col-span-4">
          <div
            class="text-center border border-border border-dashed rounded-lg px-2 py-4 duration-700 hover:!border-primary hover:bg-[#F8FCFF] dark:hover:bg-primarylight hover:border-solid"
          >
            <img class="size-14 min-w-14 inline-block relative object-cover rounded-full mb-2" src="assets/images/avatar/avatar1.jpg" alt="" />
            <h6>Jordana Niclany</h6>
            <span class="text-xs">jordan@mail.com</span>
          </div>
        </div>
        <div class="lg:col-span-4">
          <div
            class="text-center border border-border border-dashed rounded-lg px-2 py-4 duration-700 hover:!border-primary hover:bg-[#F8FCFF] dark:hover:bg-primarylight hover:border-solid"
          >
            <img class="size-14 min-w-14 inline-block relative object-cover rounded-full mb-2" src="assets/images/avatar/avatar4.jpg" alt="" />
            <h6>Jacob Jack</h6>
            <span class="text-xs">jordan@mail.com</span>
          </div>
        </div>
        <div class="lg:col-span-4">
          <div
            class="text-center border border-border border-dashed rounded-lg px-2 py-4 duration-700 hover:!border-primary hover:bg-[#F8FCFF] dark:hover:bg-primarylight hover:border-solid bg-purplelight"
          >
            <img class="size-14 min-w-14 inline-block relative object-cover rounded-full mb-2" src="assets/images/avatar/avatar3.jpg" alt="" />
            <h6>Sammy Nico</h6>
            <span class="text-xs">jordan@mail.com</span>
          </div>
        </div>
        <div class="lg:col-span-4">
          <div
            class="text-center border border-border border-dashed rounded-lg px-2 py-4 duration-700 hover:!border-primary hover:bg-[#F8FCFF] dark:hover:bg-primarylight hover:border-solid bg-cream-light"
          >
            <img class="size-14 min-w-14 inline-block relative object-cover rounded-full mb-2" src="assets/images/avatar/avatar4.jpg" alt="" />
            <h6>Gibs Gibsy</h6>
            <span class="text-xs">jordan@mail.com</span>
        ...
        <div class="lg:col-span-4">
          <div
            class="text-center border border-border border-dashed rounded-lg px-2 py-4 duration-700 hover:!border-primary hover:bg-[#F8FCFF] dark:hover:bg-primarylight hover:border-solid"
          >
            <img class="size-14 min-w-14 inline-block relative object-cover rounded-full mb-2" src="assets/images/avatar/avatar5.jpg" alt="" />
            <h6>Sam Sammy</h6>
            <span class="text-xs">jordan@mail.com</span>
          </div>
        </div>
        <div class="lg:col-span-4">
          <div
            class="text-center border border-border border-dashed rounded-lg px-2 py-4 duration-700 hover:!border-primary hover:bg-[#F8FCFF] dark:hover:bg-primarylight hover:border-solid"
          >
            <img class="size-14 min-w-14 inline-block relative object-cover rounded-full mb-2" src="assets/images/avatar/avatar6.jpg" alt="" />
            <h6>Corey Core</h6>
            <span class="text-xs">jordan@mail.com</span>
          </div>
        </div>
    ...
    <div class="sm:p-5 p-4">
      <div class="flex justify-between items-center">
        ...
        <div class="relative" x-data="{ open: false }">
          <a class="nav-link" href="javascript:void(0);" role="button" @click="open = true">
            <div class="size-10 relative inline-block text-center leading-9 rounded-lg border border-border">
          ...
          <div
            class="bg-bodybg border border-black/15 rounded-xl py-2 absolute top-full right-full min-w-40 mt-1 z-1"
            x-transition.duration.300ms
            x-show.transition.origin.top.left="open"
            x-cloak
            @click.away="open = false"
          >
            <a class="py-2 px-5 block hover:bg-primarylight hover:text-primary" href="javascript:void(0)" @click="open = false">Delete</a>
            <a class="py-2 px-5 block hover:bg-primarylight hover:text-primary" href="javascript:void(0)" @click="open = false">Edit</a>
          </div>
        </div>
      </div>
      <div id="world-map" class="active-map">
        <svg width="458" height="400">
          <g transform="scale(0.48210526315789476) translate(0, 139.84716157205236)">
            <path
              ...
              stroke-linejoin="round"
              stroke-opacity="0.25"
              fill="rgb(229 232 223)"
              original="rgb(229 232 223)"
              id="jqvmap1_id"
              class="jqvmap-region"
            ></path>
            <path
      ...
      <div class="-mt-14.5 relative dz-scroll">
        <div>
          <div class="py-3 flex border-b border-border">
            <img src="assets/images/country/india.png" alt="" class="mr-3 rounded-full" />
            <div class="flex-[1]">
          ...
          <div class="py-3 flex border-b border-border">
            <img src="assets/images/country/canada.png" alt="" class="mr-3 rounded-full" />
            <div class="flex-[1]">
              <div class="flex justify-between">
                <p>Canada</p>
                <p>30%</p>
          ...
          <div class="py-3 flex border-b border-border">
            <img src="assets/images/country/russia.png" alt="" class="mr-3 rounded-full" />
            <div class="flex-[1]">
              <div class="flex justify-between">
                <p>Russia</p>
                <p>20%</p>
          ...
          <div class="py-3 flex border-b border-border">
            <img src="assets/images/country/uk.png" alt="" class="mr-3 rounded-full" />
            <div class="flex-[1]">
              <div class="flex justify-between">
                <p>United Kingdom</p>
                <p>40%</p>
          ...
          <div class="py-3 flex border-b border-border">
            <img src="assets/images/country/aus.png" alt="" class="mr-3 rounded-full" />
            <div class="flex-[1]">
              <div class="flex justify-between">
                <p>Australia</p>
                <p>60%</p>
          ...
          <div class="py-3 flex border-b border-border">
            <img src="assets/images/country/usa.png" alt="" class="mr-3 rounded-full" />
            <div class="flex-[1]">
              <div class="flex justify-between">
                <p>United States</p>
                <p>20%</p>
          ...
          <div class="py-3 flex border-b border-border">
            <img src="assets/images/country/pak.png" alt="" class="mr-3 rounded-full" />
            <div class="flex-[1]">
              <div class="flex justify-between">
                <p>Pakistan</p>
                <p>20%</p>
          ...
          <div class="py-3 flex border-b border-border">
            <img src="assets/images/country/germany.png" alt="" class="mr-3 rounded-full" />
            <div class="flex-[1]">
              <div class="flex justify-between">
                <p>Germany</p>
                <p>80%</p>
          ...
          <div class="py-3 flex border-b border-border">
            <img src="assets/images/country/uae.png" alt="" class="mr-3 rounded-full" />
            <div class="flex-[1]">
              <div class="flex justify-between">
                <p>UAE</p>
                <p>30%</p>
          ...
          <div class="py-3 flex border-b border-border">
            <img src="assets/images/country/china.png" alt="" class="mr-3 rounded-full" />
            <div class="flex-[1]">
              <div class="flex justify-between">
                <p>China</p>
                <p>40%</p>
