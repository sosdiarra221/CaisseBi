...
// Same manual-formatting rationale as pages/(admin)/rapports/index.vue: avoid
// Number.toLocaleString()/Intl date formatting so SSR (Node ICU) and CSR
// (browser ICU) never disagree and cause hydration mismatches. Short dates
// use the shared formatDate() from lib/format.ts; only this long
